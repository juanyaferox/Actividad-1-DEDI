 ...
 * @author hulke
 */
public class JFrameGCBaja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Introduza el ID de la compañia a dar de baja");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameGCBaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameGCBaja().setVisible(true);
            }
        });
    }
