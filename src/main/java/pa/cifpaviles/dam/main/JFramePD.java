...
public class JFramePD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bVuelosCompania.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bVuelosCompaniaActionPerformed(evt);
            }
        });
        ...
        bRecaudaciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bRecaudacionesActionPerformed(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Candara", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("PERSISTENCIA DE DATOS");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/—Pngtree—airport building illustration_4620857 (1) (1).png"))); // NOI18N
    ...
    private void bLlegadasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLlegadasActionPerformed
        JFramePDLlegadas ventanaEntradas = new JFramePDLlegadas();
    ...
    private void bRecaudacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRecaudacionesActionPerformed
        JFramePDRecaudacion ventanaRecaudacion = new JFramePDRecaudacion();
        ventanaRecaudacion.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_bRecaudacionesActionPerformed

    private void bVuelosCompaniaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVuelosCompaniaActionPerformed
        JFramePDVuelosPorCompania ventanaVuelos = new JFramePDVuelosPorCompania();
        ventanaVuelos.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_bVuelosCompaniaActionPerformed
