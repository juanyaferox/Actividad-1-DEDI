 ...
 * @author hulke
 */
public class JFrameGVAlta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Introduza los datos para dar de alta el vuelo");
    ...
    private void bDarDeAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDarDeAltaActionPerformed
        ...
        String IATAdes = tIATAdes.getText();
        int Numplazas = Integer.parseInt(tNumPlazas.getText());
        String sHSO = tHSO.getText();
        String sHLO = tHLO.getText();
        String DSO = tDSO.getText();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm");
        LocalTime HSO = LocalTime.parse(sHSO, formatter);
        LocalTime HLO = LocalTime.parse(sHLO, formatter);
        gestion.altaV(codigo, IATAor, IATAdes, Numplazas, HSO, HLO, DSO);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameGVAlta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameGVAlta().setVisible(true);
            }
        });
    }
