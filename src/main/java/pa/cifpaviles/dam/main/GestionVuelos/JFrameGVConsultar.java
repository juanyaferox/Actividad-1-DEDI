 ...
 * @author hulke
 */
public class JFrameGVConsultar extends javax.swing.JFrame {

    /**
     * Creates new form JFrameGCConsultar
     */
    public JFrameGVConsultar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Introduza el código del vuelo a consultar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameGVConsultar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameGVConsultar().setVisible(true);
            }
        });
    }
