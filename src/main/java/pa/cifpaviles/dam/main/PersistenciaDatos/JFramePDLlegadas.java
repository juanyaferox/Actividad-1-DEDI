 ...
 * @author hulke
 */
public class JFramePDLlegadas extends javax.swing.JFrame {

    /**
     * Creates new form JFramePDSalidas
     */
    public JFramePDLlegadas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramePDLlegadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFramePDLlegadas().setVisible(true);
            }
        });
    }
